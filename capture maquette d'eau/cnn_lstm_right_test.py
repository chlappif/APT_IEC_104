...
traindata = pd.read_table('right_raspi_data.txt', delimiter=",", header=None)
testdata = pd.read_table('right_raspi_test_data.txt', header=None, delimiter=",")
...
cnn.load_weights("cnn_lstm_model_right.hdf5")
